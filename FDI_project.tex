...
For citation: \\
you have to add your reference firstly in bibCG. After having done so you can always include the reference in the actual file as follows: \\(\textit{see}\cite{michael1973education}; \cite{heckman1980life}).  \\
or Starting with \citet{biddle1990sleep}
