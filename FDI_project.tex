...
Our analysis is based on observational firm-level data. The dataset comprises 11,323 firms, of which 4,460 received FDI in 2016. The FDIs are categorized into three different types: Exports-oriented, technology intensive and domestic market seeking FDI. The outcome variables TFP and wages were measured in 2017. The baseline variables were measured in 2015 (one year prior to the intervention) and comprise information on:
...
\begin{table}[ht!]
	\caption{Pre-Matching Balancing Test}
	\centering
    \begin{adjustbox}{max width=1.0\linewidth}
		\import{C:\Users\Emilie\Documents\Emilie\Uni\Master\Nottingham\2_Appl_Microeconometrics\fdimatching_clean\04_results\02_Descriptive_Analysis\} {baltest_byfdi_pre.tex}
		\label{tab1}
    \end{adjustbox}
\end{table}
\FloatBarrier 
...
\begin{table}[ht!]
	\caption{Covariate Balance comparing logit and probit model}
	\centering
    \begin{adjustbox}{max width=1.0\linewidth}
		\input{covbal_tables.tex}
		\label{tab1}
    \end{adjustbox}
\end{table}
\FloatBarrier 
