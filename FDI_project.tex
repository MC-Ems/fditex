...
We have further assumed that a port being within 500 km of the firm does not influence productivity. Column (3) confirms that this is the case, as the results do not change with the inclusion of the dummy variable port in our set of covariates. 
